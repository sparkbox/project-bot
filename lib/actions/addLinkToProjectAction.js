...
class AddLinkToProjectAction {
  ...
  async execute(params, context) {
    ...
    const projectLink = new ProjectLink(context, paramsObj.label, paramsObj.link);
    await projectLink.save();
    return new AddLinkToProjectResponse(paramsObj.label, paramsObj.link);
  }
}

// const project = new AddLinkToProjectAction();
// project.execute('sparkbox seesparkbox.com', { id: 'c4362' });
